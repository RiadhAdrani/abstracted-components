...
class RepeatingRadialGradient {
      ...
      * @returns `repeating-radial-gradient(shape size at position, color_1 position_1, color_2 position_2 ... color_n position_n)`
      */
     static new(
          ...
          return `repeating-radial-gradient(${sh} ${sz} at ${pt}, ${validColors})`;
     }
}

export default RepeatingRadialGradient;
